...
/* *************************************** */
    ...
    /** Column of the good til canceled (GTC) indicator of the contract to buy. */
    private static  final   int     BUY_GTC        = 6;
    /** Column of the status of the contract to buy. */
    private static  final   int     BUY_STATUS      = 7;
    /** Column of the actual price of the contract bought. */
    private static  final   int     BUY_ACTUAL      = 8;
    /** Column of the notes on the contract to buy. */
    private static  final   int     BUY_TICKET      = 9;
    /** Column of the notes on the contract to buy. */
    private static  final   int     BUY_NOTE        = 10;
    /** Column of a break between the buy and sell sections. */
    private static  final   int     BUY_BREAK       = 11;
    /** Column of the sell date. */
    private static  final   int     SELL_DATE       = 12;
    /** Column of the number of contracts to sell. */
    private static  final   int     SELL_NUMBER     = 13;
    /** Column of the month of the contract to sell. */
    private static  final   int     SELL_MONTH      = 14;
    /** Column of the commodity of the contract to sell. */
    private static  final   int     SELL_COMMODITY  = 15;
    /** Column of the price of the contract to sell. */
    private static  final   int     SELL_PRICE      = 16;
    /** Column of the stop loss of the contract to sell. */
    private static  final   int     SELL_STOP       = 17;
    /** Column of the good til canceled (GTC) indicator of the contract to sell. */
    private static  final   int     SELL_GTC        = 18;
    /** Column of the status of the contract to sell. */
    private static  final   int     SELL_STATUS     = 19;
    /** Column of the actual price of the contract sold. */
    private static  final   int     SELL_ACTUAL     = 20;
    /** Column of the notes on the contract to sell. */
    private static  final   int     SELL_TICKET     = 21;
    /** Column of the notes on the contract to sell. */
    private static  final   int     SELL_NOTE       = 22;
    /** Column of a break between the sell and profit sections. */
    private static  final   int     SELL_BREAK      = 23;
    /** Column of the profit amount from a bought and sold contract. */
    private static  final   int     PROFIT          = 24;
    ...
    /** A contract order status of replaced has been taken */
    public  static  final   String  REPLACED        = "Replaced";
    /** A contract order status of expired has been taken */
    public  static  final   String  EXPIRED         = "Expired";

    /** The weighting of order statuses for sorting purposes */
    private static  final   int[] STATUS_SORT_WEIGHTS = {0, 1, 2, 3, 2, 0, 0, 0}; // based on the order STATUSES is filled.

    /** A table of valid status values that can be taken based on the current status value */
    //                                                             00,    01,    02,    03,    04,    05,    06,    07 <change to   V-currently
    private static  final   boolean[][] STATUS_CHANGES      = {{ true,  true, false, false, false, false, false, false},  // 00 - NO_STATUS
                                                               { true,  true,  true, false, false, false, false, false},  // 01 - CONSIDERATION
                                                               {false,  true,  true,  true,  true, false,  true,  true},  // 02 - PLACED
                                                               {false, false,  true,  true, false, false, false, false},  // 03 - FILLED
                                                               {false, false,  true,  true,  true,  true, false, false},  // 04 - CANCEL_PLACED
                                                               {false, false, false, false,  true,  true, false, false},  // 05 - CANCELLED
                                                               {false, false,  true,  true, false, false,  true, false},  // 06 - REPLACED
                                                               {false, false,  true,  true, false, false, false,  true}}; // 07 - EXPIRED
    /** A table of valid status combinations between a buy and sell order. */
    //                                                             00,    01,    02,    03,    04,    05,    06,    07 <change to   V-Opposite side
    private static  final   boolean[][] STATUS_COMBINATIONS = {{ true,  true,  true,  true,  true,  true,  true,  true},  // 00 - NO_STATUS
                                                               { true,  true,  true,  true,  true,  true,  true,  true},  // 01 - CONSIDERATION
                                                               { true,  true,  true,  true,  true,  true,  true,  true},  // 02 - PLACED
                                                               { true,  true,  true,  true,  true,  true,  true,  true},  // 03 - FILLED
                                                               { true,  true,  true,  true,  true,  true,  true,  true},  // 04 - CANCEL_PLACED
                                                               { true, false,  true,  true,  true,  true,  true,  true},  // 05 - CANCELLED
                                                               { true,  true,  true,  true,  true,  true,  true,  true},  // 06 - REPLACED
                                                               { true,  true,  true,  true,  true,  true,  true,  true}}; // 07 - EXPIRED

    //                                                             00,    01,    02,    03,    04,    05,    06,    07    <2nd   v 1st
/* In case I screw this up
    private static  final   boolean[][] STATUS_COMBINATIONS = {{ true,  true,  true,  true,  true,  true, false, false},  // 00 - NO_STATUS
                                                               { true,  true,  true,  true,  true,  true, false, false},  // 01 - CONSIDERATION
                                                               { true,  true,  true,  true,  true,  true, false, false},  // 02 - PLACED
                                                               { true,  true,  true,  true,  true,  true, false, false},  // 03 - FILLED
                                                               { true,  true,  true,  true,  true,  true, false, false},  // 04 - CANCEL_PLACED
                                                               { true, false,  true,  true,  true,  true, false, false},  // 05 - CANCELLED
                                                               {false, false,  true,  true, false, false,  true, false},  // 06 - REPLACED
                                                               {false, false,  true, false, false, false, false,  true}}; // 07 - EXPIRED
*/
/* *************************************** */
/* *** INSTANCE VARIABLES              *** */
/* *************************************** */
...
/* *************************************** */
    ...
    private class ContractTableModel extends AbstractTableModel implements PriceListener {
        ...
        //                                                     00,    01,    02,    03,    04,    05,    06,    07    <2nd   v 1st
        private final   boolean[][] EDIT_DATE_CELL      = {{ true,  true,  true,  true, false, false, false, false},  // 00 - NO_STATUS
                                                           { true,  true,  true,  true, false, false, false, false},  // 01 - CONSIDERATION
                                                           {false, false, false, false, false, false, false, false},  // 02 - PLACED
                                                           {false, false, false, false, false, false, false, false},  // 03 - FILLED
                                                           {false, false, false, false, false, false, false, false},  // 04 - CANCEL_PLACED
                                                           {false, false, false, false, false, false, false, false},  // 05 - CANCELLED
                                                           {false, false, false, false, false, false, false, false},  // 06 - REPLACED
                                                           {false, false, false, false, false, false, false, false}}; // 07 - EXPIRED

        /** The editable state of the number of contract cells based on the status of the buy and sell order. */
        //                                                     00,    01,    02,    03,    04,    05,    06,    07    <2nd   v 1st
        private final   boolean[][] EDIT_NUMBER_CELL    = {{ true,  true,  true,  true, false, false, false, false},  // 00 - NO_STATUS
                                                           { true,  true,  true,  true, false, false, false, false},  // 01 - CONSIDERATION
                                                           {false, false, false, false, false, false, false, false},  // 02 - PLACED
                                                           { true,  true,  true,  true,  true,  true,  true,  true},  // 03 - FILLED
                                                           {false, false, false, false, false, false, false, false},  // 04 - CANCEL_PLACED
        ...
        //                                                     00,    01,    02,    03,    04,    05,    06,    07    <2nd   v 1st
        private final   boolean[][] EDIT_COMMODITY_CELL = {{ true, false, false, false, false, false, false, false},  // 00 - NO_STATUS
                                                           {false, false, false, false, false, false, false, false},  // 01 - CONSIDERATION
                                                           {false, false, false, false, false, false, false, false},  // 02 - PLACED
                                                           {false, false, false, false, false, false, false, false},  // 03 - FILLED
                                                           {false, false, false, false, false, false, false, false},  // 04 - CANCEL_PLACED
                                                           {false, false, false, false, false, false, false, false},  // 05 - CANCELLED
        ...
        //                                                     00,    01,    02,    03,    04,    05,    06,    07    <2nd   v 1st
        private final   boolean[][] EDIT_PRICE_CELL     = {{ true,  true,  true,  true, false, false, false, false},  // 00 - NO_STATUS
                                                           { true,  true,  true,  true, false, false, false, false},  // 01 - CONSIDERATION
                                                           {false, false, false, false, false, false, false, false},  // 02 - PLACED
                                                           {false, false, false, false, false, false, false, false},  // 03 - FILLED
                                                           {false, false, false, false, false, false, false, false},  // 04 - CANCEL_PLACED
        ...
        //                                                     00,    01,    02,    03,    04,    05,    06,    07    <2nd   v 1st
        private final   boolean[][] EDIT_STOP_CELL      = {{ true,  true,  true,  true, false, false, false, false},  // 00 - NO_STATUS
                                                           { true,  true,  true,  true, false, false, false, false},  // 01 - CONSIDERATION
                                                           {false, false, false, false, false, false, false, false},  // 02 - PLACED
                                                           {false, false, false, false, false, false, false, false},  // 03 - FILLED
                                                           {false, false, false, false, false, false, false, false},  // 04 - CANCEL_PLACED
        ...
        /** The editable state of the good til cells based on the status of the buy and sell order. */
        //                                                     00,    01,    02,    03,    04,    05,    06,    07    <2nd   v 1st
        private final   boolean[][] EDIT_GTC_CELL       = {{ true,  true,  true,  true, false, false, false, false},  // 00 - NO_STATUS
                                                           { true,  true,  true,  true, false, false, false, false},  // 01 - CONSIDERATION
                                                           {false, false, false, false, false, false, false, false},  // 02 - PLACED
                                                           {false, false, false, false, false, false, false, false},  // 03 - FILLED
                                                           {false, false, false, false, false, false, false, false},  // 04 - CANCEL_PLACED
        ...
        //                                                     00,    01,    02,    03,    04,    05,    06,    07    <2nd   v 1st
        private final   boolean[][] EDIT_ACTUAL_CELL    = {{false, false, false, false, false, false, false, false},  // 00 - NO_STATUS
                                                           {false, false, false, false, false, false, false, false},  // 01 - CONSIDERATION
                                                           {false, false, false, false, false, false, false, false},  // 02 - PLACED
                                                           { true,  true,  true,  true,  true,  true,  true,  true},  // 03 - FILLED
                                                           {false, false, false, false, false, false, false, false},  // 04 - CANCEL_PLACED
        ...
        /** The editable state of the stoploss cells based on the status of the buy and sell order. */
        //                                                     00,    01,    02,    03,    04,    05,    06,    07    <2nd   v 1st
        private final   boolean[][] EDIT_TICKET_CELL    = {{false, false, false, false, false, false, false, false},  // 00 - NO_STATUS
                                                           {false, false, false, false, false, false, false, false},  // 01 - CONSIDERATION
                                                           { true,  true,  true,  true,  true,  true,  true,  true},  // 02 - PLACED
                                                           {false, false, false, false, false, false, false, false},  // 03 - FILLED
                                                           {false, false, false, false, false, false, false, false},  // 04 - CANCEL_PLACED
        ...
        private String columnNames[] = {"B.Date", "B.#", "B.M", "B.Commodity", "B.Price", "S.Stop", "B.GTC", "B.Status", "B.Actual", "B.Ticket", "B.Note", ".",
                                        "S.Date", "S.#", "S.M", "S.Commodity", "S.Price", "B.Stop", "S.GTC", "S.Status", "S.Actual", "S.Ticket", "S.Note", ",", "Profit"};
...
// does this work     case BUY_STOP:      line.getLongOrder().setStopPrice((boolVal.booleanValue())?new Double(1):new Double(0));
//                                        break;
...
//If we need an order good til a date, change this to use the date as a long, 0 is day order, and 1 is GTC
                case BUY_GTC:       if ("".equals(line.getLongOrder().getCommodityName().trim())) {
                                        return new Boolean(false);
                                    } else {
                                        return (line.getLongOrder().getGoodTil().intValue() == ContractOrder.GOOD_TIL_DAY)?new Boolean(false):new Boolean(true);
                                    }
                ...
                case BUY_TICKET:    return line.getLongOrder().getTicket();
...
//If we need an order good til a date, change this to use the date as a long, 0 is day order, and 1 is GTC
                case SELL_GTC:      if ("".equals(line.getShortOrder().getCommodityName().trim())) {
                                        return new Boolean(false);
                                    } else {
                                        return (line.getShortOrder().getGoodTil().intValue() == ContractOrder.GOOD_TIL_DAY)?new Boolean(false):new Boolean(true);
                                    }
                ...
                case SELL_TICKET:   return line.getShortOrder().getTicket();
    ...
    /* *************************************** */
        ...
        /**
         *  Gets the class of the object in the column.  Makes it possible to
         *  render checkboxes in the table.
         *
         *  @param  columnIndex the column number to get the class for
         *  @return     the name of the column
         */
            ...
            try {
                switch(col) {
                    ...
                    case BUY_STOP:      line.getLongOrder().setStopPrice((boolVal.booleanValue())?new Double(1):new Double(0));
                                        break;
                    case BUY_GTC:       line.getLongOrder().setGoodTil((boolVal.booleanValue())?ContractOrder.GOOD_TIL_CANCELLED:ContractOrder.GOOD_TIL_DAY);
                                        break;
/*
...
*/
                    case BUY_STATUS:    line.getLongOrder().setStatus(val);
                    ...
                    case BUY_ACTUAL:    line.getLongOrder().setActualPrice(("".equals(val.trim()))?new Double(0):Double.valueOf(val.trim()));
                                        ...
                                        break;
                    case BUY_TICKET:    line.getLongOrder().setTicket(val.trim());
                                        break;
                    ...
                    case SELL_PRICE:    val = val.trim();
                                        ...
                                        break;
                    case SELL_STOP:      line.getShortOrder().setStopPrice((boolVal.booleanValue())?new Double(1):new Double(0));
                                        break;
                    case SELL_GTC:      line.getShortOrder().setGoodTil((boolVal.booleanValue())?ContractOrder.GOOD_TIL_CANCELLED:ContractOrder.GOOD_TIL_DAY);
                                        break;
/*
...
*/
                    case SELL_STATUS:   line.getShortOrder().setStatus(val);
                    ...
                    case SELL_ACTUAL:   line.getShortOrder().setActualPrice(("".equals(val.trim()))?new Double(0):Double.valueOf(val.trim()));
                                        fireTableCellUpdated(row, PROFIT);
                                        break;
                    case SELL_TICKET:   line.getShortOrder().setTicket(val.trim());
                                        break;
...
//                                        fireTableRowsUpdated(row, row);
        ...
        public boolean isCellEditable(int row, int column) {
            ...
            } else if ((column == BUY_GTC) || (column == SELL_GTC)) {             // Good til columns
                if ("".equals(((String)table.getValueAt(row, BUY_COMMODITY)).trim()) ||
                    "".equals(((String)table.getValueAt(row, BUY_MONTH)).trim())) {
                    return false;
                }
                if (column == BUY_GTC) {
                    return EDIT_GTC_CELL[buyStatusValue][sellStatusValue];
                } else if (column == SELL_GTC) {
                    return EDIT_GTC_CELL[sellStatusValue][buyStatusValue];
                }
            ...
            } else if ((column == BUY_TICKET) || (column == SELL_TICKET)) {             // note columns
                if ("".equals(((String)table.getValueAt(row, BUY_COMMODITY)).trim()) ||
                    "".equals(((String)table.getValueAt(row, BUY_MONTH)).trim())) {
                    return false;
                }
                if (column == BUY_TICKET) {
                    return EDIT_TICKET_CELL[buyStatusValue][sellStatusValue];
                } else if (column == SELL_TICKET) {
                    return EDIT_TICKET_CELL[sellStatusValue][buyStatusValue];
                }
    ...
    /* *************************************** */
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            } else if ((column == BUY_TICKET) || (column == SELL_TICKET)) {           // Ticket columns
                setHorizontalAlignment(CENTER);
                if (table.isCellEditable(row, column)) {
                    setBackground(Color.CYAN);
                }
...
// Make this into a border if possible
    ...
    /**
     *  BooleanRenderer is the cell renderer for the columns which have boolean values.
     *
     *  @author J.R. Titko
     *  @version 1.0
     *  @update 2004.04.06
    ...
    private void setupGUI() {
        ...
        table = new JTable(tableModel) {
            public TableCellRenderer getCellRenderer(int row, int column) {
                if (column == BUY_STOP || column == SELL_STOP ||
                    column == BUY_GTC  || column == SELL_GTC) {
        ...
        table.getColumn(tableModel.getColumnName(BUY_NUMBER)).setPreferredWidth(10);
        table.getColumn(tableModel.getColumnName(BUY_MONTH)).setPreferredWidth(40);
        table.getColumn(tableModel.getColumnName(BUY_MONTH)).setCellEditor(new DefaultCellEditor(monthComboBox));
        table.getColumn(tableModel.getColumnName(BUY_COMMODITY)).setPreferredWidth(140);
        table.getColumn(tableModel.getColumnName(BUY_COMMODITY)).setCellEditor(new DefaultCellEditor(commodityComboBox));
        table.getColumn(tableModel.getColumnName(BUY_PRICE)).setPreferredWidth(30);
        table.getColumn(tableModel.getColumnName(BUY_STOP)).setPreferredWidth(25);
        table.getColumn(tableModel.getColumnName(BUY_GTC)).setPreferredWidth(25);
        ...
        table.getColumn(tableModel.getColumnName(BUY_ACTUAL)).setPreferredWidth(40);
        table.getColumn(tableModel.getColumnName(BUY_TICKET)).setPreferredWidth(45);
        table.getColumn(tableModel.getColumnName(BUY_NOTE)).setPreferredWidth(160);
        ...
        table.getColumn(tableModel.getColumnName(SELL_NUMBER)).setPreferredWidth(10);
        table.getColumn(tableModel.getColumnName(SELL_MONTH)).setPreferredWidth(40);
        table.getColumn(tableModel.getColumnName(SELL_MONTH)).setCellEditor(new DefaultCellEditor(monthComboBox));
        table.getColumn(tableModel.getColumnName(SELL_COMMODITY)).setPreferredWidth(140);
        table.getColumn(tableModel.getColumnName(SELL_COMMODITY)).setCellEditor(new DefaultCellEditor(commodityComboBox));
        table.getColumn(tableModel.getColumnName(SELL_PRICE)).setPreferredWidth(30);
        table.getColumn(tableModel.getColumnName(SELL_STOP)).setPreferredWidth(25);
        table.getColumn(tableModel.getColumnName(SELL_GTC)).setPreferredWidth(25);
        ...
        table.getColumn(tableModel.getColumnName(SELL_ACTUAL)).setPreferredWidth(40);
        table.getColumn(tableModel.getColumnName(SELL_TICKET)).setPreferredWidth(45);
        table.getColumn(tableModel.getColumnName(SELL_NOTE)).setPreferredWidth(160);
