...
/* *************************************** */
    ...
    private static  final   int     BUY_TICKET      = 8;
    /** Column of the notes on the contract to buy. */
    private static  final   int     BUY_NOTE        = 9;
    /** Column of a break between the buy and sell sections. */
    private static  final   int     BUY_BREAK       = 10;
    /** Column of the sell date. */
    private static  final   int     SELL_DATE       = 11;
    /** Column of the number of contracts to sell. */
    private static  final   int     SELL_NUMBER     = 12;
    /** Column of the month of the contract to sell. */
    private static  final   int     SELL_MONTH      = 13;
    /** Column of the commodity of the contract to sell. */
    private static  final   int     SELL_COMMODITY  = 14;
    ...
    private static  final   int     SELL_STOP       = 16;
    /** Column of the status of the contract to sell. */
    private static  final   int     SELL_STATUS     = 17;
    /** Column of the actual price of the contract sold. */
    private static  final   int     SELL_ACTUAL     = 18;
    /** Column of the notes on the contract to sell. */
    private static  final   int     SELL_TICKET     = 19;
    /** Column of the notes on the contract to sell. */
    private static  final   int     SELL_NOTE       = 20;
    /** Column of a break between the sell and profit sections. */
    private static  final   int     SELL_BREAK      = 21;
    /** Column of the profit amount from a bought and sold contract. */
    private static  final   int     PROFIT          = 22;
    ...
    private static  final   boolean[][] STATUS_CHANGES      = {{ true,  true, false, false, false, false, false},  // 00 - NO_STATUS
                                                               ...
                                                               {false, false,  true,  true, false, false, false},  // 03 - FILLED
    ...
    //                                                             00,    01,    02,    03,    04,    05,    06    <2nd   v 1st
    private static  final   boolean[][] STATUS_COMBINATIONS = {{ true,  true,  true,  true,  true,  true, false},  // 00 - NO_STATUS
                                                               { true,  true,  true,  true,  true,  true, false},  // 01 - CONSIDERATION
                                                               { true,  true,  true,  true,  true,  true, false},  // 02 - PLACED
                                                               { true,  true,  true,  true,  true,  true, false},  // 03 - FILLED
                                                               { true,  true,  true,  true,  true,  true, false},  // 04 - CANCEL_PLACED
...
*/
        ...
        /** The editable state of the stoploss cells based on the status of the buy and sell order. */
        //                                                     00,    01,    02,    03,    04,    05,    06    <2nd   v 1st
        private final   boolean[][] EDIT_TICKET_CELL    = {{false, false, false, false, false, false, false},  // 00 - NO_STATUS
                                                           {false, false, false, false, false, false, false},  // 01 - CONSIDERATION
                                                           { true,  true,  true,  true,  true,  true,  true},  // 02 - PLACED
                                                           {false, false, false, false, false, false, false},  // 03 - FILLED
                                                           {false, false, false, false, false, false, false},  // 04 - CANCEL_PLACED
        ...
        private String columnNames[] = {"B.Date", "B.#", "B.M", "B.Commodity", "B.Price", "S.Stop", "B.Status", "B.Actual", "B.Ticket", "B.Note", ".",
                                        "S.Date", "S.#", "S.M", "S.Commodity", "S.Price", "B.Stop", "S.Status", "S.Actual", "S.Ticket", "S.Note", ",", "Profit"};
...
System.out.println("ContractOrderTablePanel.getColumnClass() - index = " + columnIndex + " className = " +  getValueAt(0, columnIndex).getClass().getName());
...
//jrt
//fireTableCellUpdated(row, PROFIT);
System.out.println("ContractOrderTablePanel.changeClosePrice - start");
            boolean found = false;
...
System.out.println("ContractOrderTablePanel.changeClosePrice - fireTableRowsUpdated(" + i + ", " + i + ")");
                    fireTableRowsUpdated(i, i);
                    found = true;
                }
            }
            if (!found) {
System.out.println("ContractOrderTablePanel.changeClosePrice - removing price listener");
                e.getContract().removePriceListener(this);
            }
System.out.println("ContractOrderTablePanel.changeClosePrice - exit");
...
/* *************************************** */
    ...
    private void setupGUI() {
        ...
        table.getColumn(tableModel.getColumnName(BUY_PRICE)).setPreferredWidth(40);
        table.getColumn(tableModel.getColumnName(BUY_STOP)).setPreferredWidth(30);
        ...
        table.getColumn(tableModel.getColumnName(BUY_TICKET)).setPreferredWidth(60);
        table.getColumn(tableModel.getColumnName(BUY_NOTE)).setPreferredWidth(130);
        ...
        table.getColumn(tableModel.getColumnName(SELL_PRICE)).setPreferredWidth(40);
        table.getColumn(tableModel.getColumnName(SELL_STOP)).setPreferredWidth(30);
        ...
        table.getColumn(tableModel.getColumnName(SELL_TICKET)).setPreferredWidth(60);
        table.getColumn(tableModel.getColumnName(SELL_NOTE)).setPreferredWidth(130);
