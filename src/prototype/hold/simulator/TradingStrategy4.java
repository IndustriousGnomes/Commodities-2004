...
/**
 *  The TradingStrategy4 simulates the daily actions of the commodity
...
//    private static final int OPTIMIZATION_PERIOD_MONTHS = 1;
    ...
    private static final String REPORT_FILE = "D:\\JavaProjects\\Commodities\\SimulatorReports\\Simulator4Report";
...
/* *************************************** */
     ...
     */
    public TradingStrategy4(LinkedList contracts) {
...
Debug.println(DEBUG, this, "clearSimulatorOrders() start");
        ...
        try {
            ...
            sb.append("delete from Simulator_Orders where simulator_run = 4");
