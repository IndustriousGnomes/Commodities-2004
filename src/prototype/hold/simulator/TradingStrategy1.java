...
/**
 *  The TradingStrategy1 simulates the daily actions of the commodity
...
//    private static final int OPTIMIZATION_PERIOD_MONTHS = 1;
    ...
    private static final String REPORT_FILE = "D:\\JavaProjects\\Commodities\\SimulatorReports\\Simulator1Report";
...
/* *************************************** */
     ...
     */
    public TradingStrategy1(LinkedList contracts) {
...
Debug.println(DEBUG, this, "wrapUpProcessing - shortOpenOrders.size(" + contract.getName() + ") = " + orders.size());
            if (orders.size() > 0) {
                processRecommendation(contract,
...
Debug.println(DEBUG, this, "wrapUpProcessing - mediumOpenOrders.size(" + contract.getName() + ") = " + orders.size());
            if (orders.size() > 0) {
                processRecommendation(contract,
                                      (((Order)orders.getFirst()).isBuy())?Recommendation.SELL:Recommendation.BUY,
                                      purchaseDate,
...
Debug.println(DEBUG, this, "wrapUpProcessing - longOpenOrders.size(" + contract.getName() + ") = " + orders.size());
            if (orders.size() > 0) {
                processRecommendation(contract,
                                      (((Order)orders.getFirst()).isBuy())?Recommendation.SELL:Recommendation.BUY,
                                      purchaseDate,
...
Debug.println(DEBUG, this, "processRecommendation - openOrders.size(" + contract.getName() + ") = " + orders.size());
...
Debug.println(DEBUG, this, "processOverallOrders - totalOpenOrders.size(" + contract.getName() + ") = " + orders.size());
        Iterator it = null;
    ...
    private void processStopLosses(Contract         contract,
        ...
        LinkedList orders = (LinkedList)openOrders.get(contract);
Debug.println(DEBUG, this, "processStopLosses - openOrders.size(" + contract.getName() + ") = " + orders.size());
        Iterator it = orders.iterator();
        while (it.hasNext()) {
            Order order = (Order)it.next();
            if (order.isBuy()) {
...
Debug.println(DEBUG, this, "buy stoploss executed");
...
Debug.println(DEBUG, this, "sell stoploss executed");
...
Debug.println(DEBUG, this, "calculateProfit - openOrders.size(" + contract.getName() + ") = " + orders.size());
...
Debug.println(DEBUG, this, "reportResults - shortOpenOrders.size(" + contract.getName() + ") = " + orders.size());
    ...
    // Medium
            ...
            orders = (LinkedList)mediumOpenOrders.get(contract);
Debug.println(DEBUG, this, "reportResults - mediumOpenOrders.size(" + contract.getName() + ") = " + orders.size());
            openProfit = calculateProfit(contract, orders, purchasePrice);
    ...
    // Long
            ...
            orders = (LinkedList)longOpenOrders.get(contract);
Debug.println(DEBUG, this, "reportResults - longOpenOrders.size(" + contract.getName() + ") = " + orders.size());
            openProfit = calculateProfit(contract, orders, purchasePrice);
...
Debug.println(DEBUG, this, "reportResults - totalOpenOrders.size(" + contract.getName() + ") = " + orders.size());
            openProfit = calculateProfit(contract, orders, purchasePrice);
...
Debug.println(DEBUG, this, "clearSimulatorOrders() start");
        ...
        try {
            ...
            sb.append("delete from Simulator_Orders where simulator_run = 1 ");
