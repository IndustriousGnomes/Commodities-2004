...
Debug.println(DEBUG, this, "StochasticTest.GraphPanel.getYBuffer() only");
            return 0;
        }
...
Debug.println(DEBUG, this, "StochasticTest.GraphPanel.getMaxValue() only");
            return 100.0;
        }
...
Debug.println(DEBUG, this, "StochasticTest.GraphPanel.getMinValue() only");
            return 0.0;
        }
...
Debug.println(DEBUG, this, "StochasticTest.GraphPanel.getTickSize() only");
            return 1;
        }
...
Debug.println(DEBUG, this, "StochasticTest.GraphPanel.redrawComponent() start");
            ...
            g.drawLine(xAxisLeft, yAxisBottom - (int)(stats.getPercent() / scale), xAxisRight, yAxisBottom - (int)(stats.getPercent() / scale));
            g.drawLine(xAxisLeft, yAxisTop + (int)(stats.getPercent() / scale), xAxisRight, yAxisTop + (int)(stats.getPercent() / scale));
...
//System.out.println("Stochastic recommend BUY");
            recommendation = Recommendation.BUY;
        } else if ((kYesterday >= (100 - percent)) && (k < (100 - percent))) {
//System.out.println("Stochastic recommend SELL");
            recommendation = Recommendation.SELL;
        }
//else {
//System.out.println("Stochastic recommend NO ACTION");
//}
