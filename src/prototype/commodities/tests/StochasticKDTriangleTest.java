...
Debug.println(DEBUG, this, "StochasticKDTriangleTest.GraphPanel.getYBuffer() only");
            return 0;
        }
...
Debug.println(DEBUG, this, "StochasticKDTriangleTest.GraphPanel.getMaxValue() only");
            return 100.0;
        }
...
Debug.println(DEBUG, this, "StochasticKDTriangleTest.GraphPanel.getMinValue() only");
            return 0.0;
        }
...
Debug.println(DEBUG, this, "StochasticKDTriangleTest.GraphPanel.getTickSize() only");
            return 1;
        }
