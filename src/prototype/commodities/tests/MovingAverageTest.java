...
/**
 *  The MovingAverageTest performs the moving average test for a commodity.
 *
 *  @author J.R. Titko
 */
public class MovingAverageTest extends TechnicalTestAbstract {
...
/* *************************************** */
    ...
    private static final String TEST_NAME = "Moving Average";
    /** The name of the sql table associated with this test. */
    private static final String SQL_TABLE = "test_moving_averages";
...
//System.out.print("^");
            if (movingAverage == null) {
//System.out.print("o");
                movingAverage = new MovingAverage(interval, sourceMap);
...
/* *************************************** */
     ...
     */
    public MovingAverageTest(Contract contract) {
        this();
...
Debug.println(DEBUG, this, "loadParameters() start");
        ...
        try {
            ...
            sb.append("select id, param_days " +
                      "from " + sqlTable + " " +
            ...
            while (rs.next()) {
Debug.println(DEBUG, this, "loadParameters() - loading param");
                int id = rs.getInt(1);
...
Debug.println(DEBUG, this, "optimizeTest - " + contract.getSymbol() + " " + contract.getMonthFormatted());
...
//System.out.println("MovingAverageTest optimizeTest - " + contract.getSymbol() + " " + contract.getMonthFormatted() + " stat=" + stats.getName() + " ratio=" + stats.getCountRatio());
...
Debug.println(DEBUG, this, "optimizeTest() - recommendCollection cleared ****");
...
Debug.println(DEBUG, this, "makeRecommendation(java.util.Date date, StatsAbstract statsObject)");
