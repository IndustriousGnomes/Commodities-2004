...
/* *************************************** */
     ...
     */
    public GraphRedrawEvent(Object source, Graphics g, double yScale, double minTickSize, double maxValue, double minValue) {
        super(source);
Debug.println(this, "GraphRedrawEvent start");
        this.graphics = g;
        this.yScale = yScale;
        this.minTickSize = minTickSize;
        this.maxValue = maxValue;
        this.minValue = minValue;
Debug.println(this, "GraphRedrawEvent end");
    }
