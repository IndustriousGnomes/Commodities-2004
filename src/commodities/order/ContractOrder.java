...
/* *************************************** */
    ...
    /** The good til indicator for day orders. */
    public static final Integer GOOD_TIL_DAY = new Integer(0);

    /** The good til indicator for good til cancel orders. */
    public static final Integer GOOD_TIL_CANCELLED = new Integer(1);
...
/* *************************************** */
    ...
    /** The good til indicator. */
    private Integer  goodTil = GOOD_TIL_DAY;
...
/* *************************************** */
    ...
    /**
     *  Get the good til indicator for this order.  Use GOOD_TIL_DAY or GOOD_TIL_CANCELLED.
     *  @return     the stop price
     */
    public  Integer getGoodTil() {
        return goodTil;
    }
    ...
    /**
     *  Set the good til indicator for this order.  Use GOOD_TIL_DAY or GOOD_TIL_CANCELLED
     *  @param  price   the indicator
     */
    public  void setGoodTil(Integer goodTil) {
        if (!this.goodTil.equals(goodTil)) {
            this.goodTil = goodTil;
            if (!ContractOrderTablePanel.NO_STATUS.equals(status)) {
                recordOrder();
            }
    ...
    public  void setStatus(String status) {
        if (!this.status.equals(status)) {
            ...
            if (ContractOrderTablePanel.NO_STATUS.equals(status)) {
                ...
                offsettingOrder = 0;
                recordOrder();
            } else if (ContractOrderTablePanel.REPLACED.equals(status)) {
                dateCancelled = calendar.getTime();
                dateFilled = null;
                offsettingOrder = 0;
                recordOrder();
            } else if (ContractOrderTablePanel.EXPIRED.equals(status)) {
                dateCancelled = null;
                dateFilled = null;
                offsettingOrder = 0;
                recordOrder();
...
/* *************************************** */
     ...
     *  initial date, contract, desired price, stoploss price, good til indicator,
     *   status, and actual price.
    ...
    public boolean equals(ContractOrder toOrder) {
        if (acctNumber == toOrder.getAccountNumber() &&
            ...
            goodTil.equals(toOrder.getGoodTil()) &&
