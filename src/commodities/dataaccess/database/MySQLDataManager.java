...
/* ***---------------------------------*** */
   ...
   public synchronized long getLastOrderIndex() throws IOException {
        ...
        try {
            ...
            while (rs.next()) {
                collect.add(new ContractOrder(
                                    ...
                                    new Integer (rs.getInt("Good_Til")),
     ...
     *  @param  goodTil             the good til indicator
    ...
    public synchronized void updateOrderEntry(long           id,
        ...
        try {
            ...
            preparedUpdateOrderEntry.setInt   ( 9, goodTil.intValue());
            preparedUpdateOrderEntry.setString(10, status);
            preparedUpdateOrderEntry.setDouble(11, actualPrice.doubleValue());
            preparedUpdateOrderEntry.setString(12, ticket);
            preparedUpdateOrderEntry.setString(13, note);
            preparedUpdateOrderEntry.setLong  (14, offsettingOrder);

            if (dateConsidered == null) {
                preparedUpdateOrderEntry.setNull(15, java.sql.Types.DATE);
            } else {
                preparedUpdateOrderEntry.setDate(15, new java.sql.Date(dateConsidered.getTime()));
            }

            if (datePlaced == null) {
                preparedUpdateOrderEntry.setNull(16, java.sql.Types.DATE);
            } else {
                preparedUpdateOrderEntry.setDate(16, new java.sql.Date(datePlaced.getTime()));
            }

            if (dateFilled == null) {
                preparedUpdateOrderEntry.setNull(17, java.sql.Types.DATE);
            } else {
                preparedUpdateOrderEntry.setDate(17, new java.sql.Date(dateFilled.getTime()));
            }

            if (dateCancelPlaced == null) {
                preparedUpdateOrderEntry.setNull(18, java.sql.Types.DATE);
            } else {
                preparedUpdateOrderEntry.setDate(18, new java.sql.Date(dateCancelPlaced.getTime()));
            }

            if (dateCancelled == null) {
                preparedUpdateOrderEntry.setNull(19, java.sql.Types.DATE);
            } else {
                preparedUpdateOrderEntry.setDate(19, new java.sql.Date(dateCancelled.getTime()));
            }

            if (dateStopLoss == null) {
                preparedUpdateOrderEntry.setNull(20, java.sql.Types.DATE);
            } else {
                preparedUpdateOrderEntry.setDate(20, new java.sql.Date(dateStopLoss.getTime()));
            }



            preparedUpdateOrderEntry.setLong  (21, id);
            ...
            if (count == 0) {
             ...
             try {
                ...
                preparedInsertOrderEntry.setInt   (10, goodTil.intValue());
                preparedInsertOrderEntry.setString(11, status);
                preparedInsertOrderEntry.setDouble(12, actualPrice.doubleValue());
                preparedInsertOrderEntry.setString(13, ticket);
                preparedInsertOrderEntry.setString(14, note);
                preparedInsertOrderEntry.setLong  (15, offsettingOrder);

                if (dateConsidered == null) {
                    preparedInsertOrderEntry.setNull(16, java.sql.Types.DATE);
                } else {
                    preparedInsertOrderEntry.setDate(16, new java.sql.Date(dateConsidered.getTime()));
                }

                if (datePlaced == null) {
                    preparedInsertOrderEntry.setNull(17, java.sql.Types.DATE);
                } else {
                    preparedInsertOrderEntry.setDate(17, new java.sql.Date(datePlaced.getTime()));
                }

                if (dateFilled == null) {
                    preparedInsertOrderEntry.setNull(18, java.sql.Types.DATE);
                } else {
                    preparedInsertOrderEntry.setDate(18, new java.sql.Date(dateFilled.getTime()));
                }

                if (dateCancelPlaced == null) {
                    preparedInsertOrderEntry.setNull(19, java.sql.Types.DATE);
                } else {
                    preparedInsertOrderEntry.setDate(19, new java.sql.Date(dateCancelPlaced.getTime()));
                }

                if (dateCancelled == null) {
                    preparedInsertOrderEntry.setNull(20, java.sql.Types.DATE);
                } else {
                    preparedInsertOrderEntry.setDate(20, new java.sql.Date(dateCancelled.getTime()));
                }

                if (dateStopLoss == null) {
                    preparedInsertOrderEntry.setNull(21, java.sql.Types.DATE);
                } else {
                    preparedInsertOrderEntry.setDate(21, new java.sql.Date(dateStopLoss.getTime()));
                }
                ...
                System.out.println("Good_Til           = " + goodTil.intValue());
